    ...
    final List<Map<String, dynamic>> events = [
      {
        ...
        'description': 'Google Season of Docs program announced'
      },
      {
        'date': 'April 10, 2024 at 18:00 UTC',
        'description': 'Google publishes the list of accepted organizations'
      },
      {
        'date': 'April 10, 2024',
        'description': 'Doc development can officially begin'
      },
      {
        'date': 'April 10 - November 22, 2024',
        'description':
            'Hired technical writers work on documentation projects with guidance from organizations'
      },
      {
        'date': 'May 22, 2024 at 18:00 UTC',
        'description': 'Technical writer hiring deadline'
      },
      {
        'date': 'June 5, 2024 - June 12, 2024 at 18:00 UTC',
        'description':
            'First monthly evaluation period. Organization administrators submit first of four monthly evaluation forms'
      },
      {
        'date': 'July 5, 2024 - July 12, 2024 at 18:00 UTC',
        'description': 'Second monthly evaluation period'
      },
      {
        'date': 'September 5, 2024 - September 12, 2024 at 18:00 UTC',
        'description': 'Third monthly evaluation period'
      },
      {
        'date': 'October 22, 2024 - October 29, 2024 at 18:00 UTC',
        'description': 'Fourth monthly evaluation period'
      },
      {
        'date': 'November 22, 2024 - December 10, 2024 at 18:00 UTC',
        'description':
      ...
      },
      {
        ...
        'description':
            'Google publishes the 2024 Google Season of Docs case studies and aggregate project data'
      },
    ];
