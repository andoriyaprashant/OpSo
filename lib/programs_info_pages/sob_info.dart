    ...
    final List<Map<String, dynamic>> events = [
      {
        ...
        'description':
            'Student Application Period begins. Students can start applying to a track of their choice.'
      },
      {
        'date': 'February 19, 2024 at 23:59 UTC',
        'description':
            'Student Application Period ends. Application deadline for students to apply.'
      },
      {
        'date': 'February 16, 2024 - March 31, 2024',
        'description':
            'Learning Bootcamp. Screened students undergo an intensive bootcamp to learn about bitcoin.'
      },
      {
        'date': 'April 1, 2024',
        'description':
            'Project ideas for the internship program published on the website.'
      },
      {
        'date': 'April 1, 2024 - April 30, 2024',
        'description':
            'Proposal Round. Applicants submit their assignment solutions and project proposals for chosen project ideas.'
      },
      {
        'date': 'May 1, 2024 - May 7, 2024',
        'description':
            'Proposal Review Period. Mentors review and select project proposals.'
      },
      {
        'date': 'May 7, 2024',
        'description':
            'Accepted Students Announced. Accepted students are notified of their acceptance into the program.'
      },
      {
        'date': 'May 8, 2024 - May 15, 2024',
        'description':
            'Program Kick-Off and Onboarding. Accepted students are paired with mentors and start planning their projects and milestones.'
      },
      {
        'date': 'May 15, 2024 - August 15, 2024',
        'description':
            'Project Period. Students work on their Summer of Bitcoin projects.'
      },
      {
        'date': 'July 15, 2024 - July 20, 2024',
        'description':
            'Mid-term Evaluations. Mentors submit evaluations of their mentees. Passing students receive the first part of their stipend.'
      },
      {
        'date': 'August 19, 2024',
        'description':
            'Students Submit Projects. Final project report, including summaries and code submissions, due.'
      },
      {
        'date': 'August 19, 2024 - August 30, 2024',
        'description':
            'Final Evaluations. Mentors review student submissions to determine if projects are successfully completed.'
      },
      {
        'date': 'September 5, 2024',
        'description':
            'Results Announced. Students are notified of their pass/fail status. Passing students receive the final part of their stipend and a certificate of completion.'
      },
      {
        'date': 'Post Program Completion',
        'description':
            'Job Referrals. Exceptional students are offered opportunities for internships or full-time roles with bitcoin companies.'
      }
    ];
          ...
          child: Column(
            ...
            children: [
              ...
              buildOutlinedBox(
                context,
                title:
                    'Eligibility : What are the eligibility requirements for students?',
                content: 'You must:\n'
