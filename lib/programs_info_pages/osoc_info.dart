          ...
          child: Column(
            ...
            children: [
              ...
              buildOutlinedBox(
                ...
                title: 'When & Where?',
                content:
                    '1 July — 25 July From Monday to Thursday, 9AM to 5PM. On Mondays and Thursdays, we work in Brussels, on Tuesdays and Wednesdays we work remotely. You dont have to work on Fridays and weekends! You are off during holidays, but still paid!',
              ),
              const SizedBox(height: 20),
              buildOutlinedBox(
                context,
              ...
              buildOutlinedBox(
                ...
                content:
                    'Students from an EEA member state or from Switzerland are entitled to work in Belgium throughout the year under the same terms as Belgian students. EAA member state means any of the member states of the European Union, Iceland, Liechtenstein, and Norway.\n\n'
