  ...
  Widget build(BuildContext context) {
    final List<Map<String, dynamic>> codeheatEvents = [
      ...
      {'date': '2024-02-01', 'description': 'Event: Codeheat Ask Me Anything'},
      {
        'date': '2024-03-31',
        'description':
            'Codeheat period ends. Participants submit Gist with links to their work through a link on the program spreadsheet to participate in the winners evaluations.'
      },
      {'date': '2024-04-09', 'description': 'Winners Announcement'},
      {
        'date': '2024-04-16',
        'description': 'Distribute digital certificates and gifts'
      },
