...
class NotificationService {
  ...
  static Future<void> onNotificationCreatedMethod(
    ...
    logger.debug('NotificationService: Notification created - ${receivedNotification.title}');
  }

  @pragma("vm:entry-point")
  static Future<void> onNotificationDisplayedMethod(
      ReceivedNotification receivedNotification) async {
    logger.info('NotificationService: Notification displayed - ${receivedNotification.title}');
  }

  @pragma("vm:entry-point")
  static Future<void> onDismissActionReceivedMethod(
      ReceivedAction receivedAction) async {
    logger.debug('NotificationService: Notification dismissed - ${receivedAction.id}');
  }

  @pragma("vm:entry-point")
  static Future<void> onActionReceivedMethod(
      ReceivedAction receivedAction) async {
    logger.info('NotificationService: Notification action received - ${receivedAction.id}');
    final payload = receivedAction.payload;
    if (payload != null) {
      logger.debug('NotificationService: Payload received - $payload');
    }
  }
